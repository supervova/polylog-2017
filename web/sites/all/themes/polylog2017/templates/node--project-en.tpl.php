...
<?php else: // Full page ?>
  ...
  <main class="container">
    <article class="article">
      ...
      <time class="meta-date" datetime="<?php print format_date($node->created, 'custom', 'Y-m-d');?>"><?php print format_date($node->created, 'custom', 'd');?> <i><?php print format_date($node->created, 'custom', 'm');?></i> <?php print format_date($node->created, 'custom', 'Y');?></time>
      </footer>
    </article>
  </main>
